                ...
                <div className="footer_container">
                    <nav className="footer_menu">
                        ...
                        <ul className="footer_menu_list_address">
                            <Link to={"#"} className="footer_link"><p className="footer_menu_title_address"> Контакты</p>
                            </Link>
                            <Link to={"#"} className="footer_link">
                                <li className="footer_menu_item">+7 555 555-55-55</li>
                            </Link>
                            <ul className={"footer_call"}>
                                ...
                                <li className="footer_item_call">
                                    <Link to={"#"} className={"footer_link_call"}><img src="/img/viber.svg" alt="" /></Link>
                                </li>
                                <li className="footer_item_call">
